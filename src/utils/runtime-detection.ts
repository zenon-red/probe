...
export const runtimeAdapters: RuntimeAdapter[] = [
	{
		...
		async detectCurrent() {
			return (
				...
				process.argv.some((a) => a.includes("hermes"))
			);
		},
		async detectInstalled() {
			return (
				(await pathExists(join(homedir(), ".hermes"))) ||
	...
	},
	{
		...
		async detectCurrent() {
			return (
				...
				process.argv.some((a) => a.includes("openclaw"))
			);
		},
		async detectInstalled() {
			return (
				(await pathExists(join(homedir(), ".openclaw"))) ||
